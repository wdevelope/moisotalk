...
export default function MatchPage() {
  ...
  return (
    <div className="max-w-lg mx-auto py-10 font-sans text-foreground">
      ...
      <p className="text-sm text-foreground/80 mb-6">대기열에 등록하면 다른 사용자와 무작위로 매칭됩니다.</p>
      <div className="flex gap-3">
        ...
        {waiting && (
          <button onClick={cancel} className="px-4 py-2 rounded border border-foreground/20">
            취소
          </button>
        )}
      </div>
