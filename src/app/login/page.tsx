  ...
  return (
    <div className="max-w-md mx-auto py-6 md:py-10 px-4 md:px-6 font-sans text-foreground">
      <div className="bg-surface rounded-lg md:rounded-xl border border-primary/20 p-4 md:p-6 2xl:p-8 shadow-sm">
        ...
        <form onSubmit={onLogin} className="space-y-3 md:space-y-4">
          <input
        ...
        <Link
          href="/signup"
          className="mt-3 md:mt-4 w-full block text-center border border-accent/30 text-accent py-2.5 md:py-3 rounded-lg hover:bg-accent/10 transition text-sm md:text-base"
        >
          회원가입
        </Link>
        {message && (
